...
public class PL_EM_ORDEN implements Metrics, FMetrics {
	...
	private String EMPRESA_ORDENANTE; // E5604_IDEMPORD, index 6 +
										// DATOS_Q.numFields; (12)
	private String CENTRO_ORDENANTE; // E5604_IDCENORD index 7 +
										// DATOS_Q.numFields; (12)
	private String ESTADO_PAGO; // E5604_CESTADO, CODIGO index 8 +
								// DATOS_Q.numFields; (12)
	private String TIPO_ORDEN; // E5604_TORDEN (SIP,SO,FWD,RETURN) index 9 +
								// DATOS_Q.numFields; (12)
	private String CODIGO_PAIS; // E5604_CODPAIS index 10 + DATOS_Q.numFields;
								// (12)
	private String INDICADOR_RESIDENTE; // E5604_INDRES index 11 +
										// DATOS_Q.numFields; (12)
	private String MEDIO_FINANCIERO; // E5604_MEDIO index 12 +
										// DATOS_Q.numFields; (12)
	private String INDICADOR_INMEDIATEZ; // E5604_IDINMEDI index 13 +
											// DATOS_Q.numFields; (12)
	private String CODIGO_EMPRESA_DESTINO; // E5604_IDEMPRD index 20 +
											// DATOS_Q.numFields; (12)
	private String CODIGO_CENTRO_DESTINO; // E5604_IDCENTD index 21 +
											// DATOS_Q.numFields; (12)
	private String CANAL_OPERACION; // E5604_CANALOPE index 22 +
									// DATOS_Q.numFields; (12)
	...
	public PL_EM_ORDEN(String[] produbanLine, String[] line, String[] fields) {
		...
		// Offset to add in case off ISRT that adds a series of "|" at the
		// begining
		Integer offset = 0;
		...
		this.CODIGO_EMPRESA = line[FQCaptureMeta.OFFSET_numFields + offset
				+ FPL_EM_ORDEN.IDXT_CODIGO_EMPRESA];
		this.CODIGO_CENTRO = line[FQCaptureMeta.OFFSET_numFields + offset
				+ FPL_EM_ORDEN.IDXT_CODIGO_CENTRO];
		this.EMPRESA_ORDENANTE = line[FQCaptureMeta.OFFSET_numFields + offset
				+ FPL_EM_ORDEN.IDXT_EMPRESA_ORDENANTE];
		this.CENTRO_ORDENANTE = line[FQCaptureMeta.OFFSET_numFields + offset
				+ FPL_EM_ORDEN.IDXT_CENTRO_ORDENANTE];
		this.ESTADO_PAGO = line[FQCaptureMeta.OFFSET_numFields + offset
				+ FPL_EM_ORDEN.IDXT_ESTADO_PAGO];
		this.TIPO_ORDEN = line[FQCaptureMeta.OFFSET_numFields
				+ FPL_EM_ORDEN.IDXT_TIPO_ORDEN];
		this.CODIGO_PAIS = line[FQCaptureMeta.OFFSET_numFields + offset
				+ FPL_EM_ORDEN.IDXT_CODIGO_PAIS];
		this.INDICADOR_RESIDENTE = line[FQCaptureMeta.OFFSET_numFields + offset
				+ FPL_EM_ORDEN.IDXT_INDICADOR_RESIDENTE];
		this.MEDIO_FINANCIERO = line[FQCaptureMeta.OFFSET_numFields + offset
				+ FPL_EM_ORDEN.IDXT_MEDIO_FINANCIERO];
		this.INDICADOR_INMEDIATEZ = line[FQCaptureMeta.OFFSET_numFields
				+ offset + FPL_EM_ORDEN.IDXT_INDICADOR_INMEDIATEZ];
		this.CODIGO_EMPRESA_DESTINO = line[FQCaptureMeta.OFFSET_numFields
				+ offset + FPL_EM_ORDEN.IDXT_CODIGO_EMPRESA_DESTINO];
		this.CODIGO_CENTRO_DESTINO = line[FQCaptureMeta.OFFSET_numFields
				+ offset + FPL_EM_ORDEN.IDXT_CANAL_OPERACION];
		this.CANAL_OPERACION = line[FQCaptureMeta.OFFSET_numFields + offset
				+ FPL_EM_ORDEN.IDXT_CANAL_OPERACION];
		this.USUARIO_ALTA = line[FQCaptureMeta.OFFSET_numFields + offset
				+ FPL_EM_ORDEN.IDXT_USUARIO_ALTA];
		try {
			String fecha;
