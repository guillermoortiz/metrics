...
public class FactoryCreator implements FMetrics {
	...
	public static Metrics createMetric(final String[] produbanLine, final String[] line, final String[] fields){
		...
		case COMMONS.TOB_DGO_CONTAB:
			...
			if (c1 && c2) {
				...
				// 049 y 001 EFECTIVO
				lMetric = createDISPOSICION_EFECTIVO_CAJERO(produbanLine, line, fields);
			}
			else {
	...
	private static Metrics createDISPOSICION_EFECTIVO_CAJERO(
		...
		Metrics event = new DISPOSICION_EFECTIVO_CAJERO(produbanLine, line, fields);
		return event;
	}
	...
	private static Metrics createOB_DGO_CONTAB(String[] produbanLine,String[] line, String[] fields) {
	...
	public static Metrics createULTALTA(final String[] produbanLine, final String[] line, final String[] fields){				
		Metrics event = new ULTALTA(produbanLine, line, fields);
		return event;
	}	
	
	public static Metrics createPL_EM_ORDEN(final String[] produbanLine, final String[] line, final String[] fields){		
